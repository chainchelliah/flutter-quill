  ...
  static final _t = Translations.byLocale('en') +
      {
        ...
        'ar': {
          ...
          'Gallery': 'الصور',
          'Link': 'الرابط',
          'Please first select some text to transform into a link.': 'يرجى اختيار نص للتحويل إلى رابط',
        },
        'da': {
        ...
        'zh_CN': {
          ...
          'Gallery': '相簿',
          'Link': '链接',
          'Please first select some text to transform into a link.': '请先选择一些要转化为链接的文本',
        },
        'ko': {
          ...
          'Gallery': '갤러리',
          'Link': '링크',
          'Please first select some text to transform into a link.': '링크로 전환할 글자를 먼저 선택해주세요.',
        },
        'ru': {
          ...
          'Gallery': 'Галерея',
          'Link': 'Ссылка',
          'Please first select some text to transform into a link.': 'Выделите часть текста для создания ссылки.',
        },
        'es': {
        ...
        'uk': {
          ...
          'Gallery': 'Галерея',
          'Link': 'Посилання',
          'Please first select some text to transform into a link.': 'Виділіть текст для створення посилання.',
        },
      };
