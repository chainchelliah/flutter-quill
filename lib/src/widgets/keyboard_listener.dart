...
typedef CursorMoveCallback = void Function(LogicalKeyboardKey key, bool wordModifier, bool lineModifier, bool shift);
...
class KeyboardEventHandler {
  ...
  KeyEventResult handleRawKeyEvent(RawKeyEvent event) {
    ...
    if (_moveKeys.contains(key)) {
      ...
      if (key == LogicalKeyboardKey.keyZ || key == LogicalKeyboardKey.keyZ.toUpperCase()) {
        onShortcut(event.isShiftPressed ? InputShortcut.REDO : InputShortcut.UNDO);
      } else {
